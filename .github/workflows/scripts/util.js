...
exports.validateBuildValues = (args) => {
    ...
    const devBucket = process.env.npm_package_dsccViz_gcsDevBucket; //"gs://please-help-me/my-path-dev"; //
    if (devBucket === undefined) {
        throw util_1.invalidVizConfig('gcsDevBucket');
    }
    const prodBucket = process.env.npm_package_dsccViz_gcsProdBucket;//"gs://please-help-me/my-path-dev"; //
